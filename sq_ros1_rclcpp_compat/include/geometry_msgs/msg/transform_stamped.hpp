...
// Provides: geometry_msgs::msg::TransformStamped as a using-alias for the ROS 1
// type geometry_msgs::TransformStamped. Logic-layer code that declares shared_ptr

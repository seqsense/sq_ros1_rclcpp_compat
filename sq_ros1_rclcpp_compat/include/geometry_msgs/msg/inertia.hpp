...
// Provides: geometry_msgs::msg::Inertia as a using-alias for the ROS 1
// type geometry_msgs::Inertia. Logic-layer code that declares shared_ptr
...
namespace msg
{
using Inertia = ::geometry_msgs::Inertia;
}  // namespace msg
}  // namespace geometry_msgs

...
// Provides: geometry_msgs::msg::AccelWithCovariance as a using-alias for the ROS 1
// type geometry_msgs::AccelWithCovariance. Logic-layer code that declares shared_ptr

...
// Provides: geometry_msgs::msg::QuaternionStamped as a using-alias for the ROS 1
// type geometry_msgs::QuaternionStamped. Logic-layer code that declares shared_ptr

...
// Provides: diagnostic_msgs::msg::DiagnosticArray as a using-alias for the ROS 1
// type diagnostic_msgs::DiagnosticArray. Logic-layer code that declares shared_ptr

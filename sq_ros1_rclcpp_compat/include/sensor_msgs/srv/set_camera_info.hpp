...
// Provides: sensor_msgs::srv::SetCameraInfo as a using-alias for the ROS 1
// type sensor_msgs::SetCameraInfo. Logic-layer code that declares shared_ptr
...
namespace srv
{
using SetCameraInfo = ::sensor_msgs::SetCameraInfo;
}  // namespace srv
}  // namespace sensor_msgs

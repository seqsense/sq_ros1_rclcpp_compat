...
// Provides: sensor_msgs::msg::MagneticField as a using-alias for the ROS 1
// type sensor_msgs::MagneticField. Logic-layer code that declares shared_ptr
...
namespace msg
{
using MagneticField = ::sensor_msgs::MagneticField;
}  // namespace msg
}  // namespace sensor_msgs

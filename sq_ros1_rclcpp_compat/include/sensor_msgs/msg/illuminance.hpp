...
// Provides: sensor_msgs::msg::Illuminance as a using-alias for the ROS 1
// type sensor_msgs::Illuminance. Logic-layer code that declares shared_ptr
...
namespace msg
{
using Illuminance = ::sensor_msgs::Illuminance;
}  // namespace msg
}  // namespace sensor_msgs

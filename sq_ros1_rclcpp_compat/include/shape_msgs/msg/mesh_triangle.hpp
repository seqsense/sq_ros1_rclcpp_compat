...
// Provides: shape_msgs::msg::MeshTriangle as a using-alias for the ROS 1
// type shape_msgs::MeshTriangle. Logic-layer code that declares shared_ptr
...
namespace msg
{
using MeshTriangle = ::shape_msgs::MeshTriangle;
}  // namespace msg
}  // namespace shape_msgs

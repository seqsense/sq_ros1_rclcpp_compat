...
// Provides: shape_msgs::msg::SolidPrimitive as a using-alias for the ROS 1
// type shape_msgs::SolidPrimitive. Logic-layer code that declares shared_ptr
...
namespace msg
{
using SolidPrimitive = ::shape_msgs::SolidPrimitive;
}  // namespace msg
}  // namespace shape_msgs

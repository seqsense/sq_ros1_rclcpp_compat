...
// Provides: visualization_msgs::msg::ImageMarker as a using-alias for the ROS 1
// type visualization_msgs::ImageMarker. Logic-layer code that declares shared_ptr
...
namespace msg
{
using ImageMarker = ::visualization_msgs::ImageMarker;
}  // namespace msg
}  // namespace visualization_msgs

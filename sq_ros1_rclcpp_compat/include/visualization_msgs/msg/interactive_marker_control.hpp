...
// Provides: visualization_msgs::msg::InteractiveMarkerControl as a using-alias for the ROS 1
// type visualization_msgs::InteractiveMarkerControl. Logic-layer code that declares shared_ptr

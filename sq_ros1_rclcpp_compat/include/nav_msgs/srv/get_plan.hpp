...
// Provides: nav_msgs::srv::GetPlan as a using-alias for the ROS 1
// type nav_msgs::GetPlan. Logic-layer code that declares shared_ptr
...
namespace srv
{
using GetPlan = ::nav_msgs::GetPlan;
}  // namespace srv
}  // namespace nav_msgs

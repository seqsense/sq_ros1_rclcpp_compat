...
// Provides: nav_msgs::msg::MapMetaData as a using-alias for the ROS 1
// type nav_msgs::MapMetaData. Logic-layer code that declares shared_ptr
...
namespace msg
{
using MapMetaData = ::nav_msgs::MapMetaData;
}  // namespace msg
}  // namespace nav_msgs

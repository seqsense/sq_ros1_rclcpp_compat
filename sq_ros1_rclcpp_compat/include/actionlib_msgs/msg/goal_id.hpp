...
// Provides: actionlib_msgs::msg::GoalID as a using-alias for the ROS 1
// type actionlib_msgs::GoalID. Logic-layer code that declares shared_ptr
...
namespace msg
{
using GoalID = ::actionlib_msgs::GoalID;
}  // namespace msg
}  // namespace actionlib_msgs
